...
const cookieCategories = [
  {
    ...
    description: 'These cookies are essential for the Zynex platform to function. They enable core features like authentication, session management, security, and load balancing. Without these cookies, the service cannot operate. They cannot be disabled.',
    cookies: [
      { name: 'zynex_session', purpose: 'Maintains your authenticated session', duration: 'Session' },
      { name: 'zynex_csrf', purpose: 'Prevents cross-site request forgery attacks', duration: 'Session' },
      { name: 'zynex_lb', purpose: 'Distributes traffic across servers for optimal performance', duration: '1 hour' },
      { name: 'zynex_consent', purpose: 'Stores your cookie consent preferences', duration: '12 months' },
      { name: 'zynex_auth', purpose: 'Authenticates your identity across modules', duration: '30 days' },
    ],
    required: true,
  },
  {
    ...
    cookies: [
      { name: 'zynex_lang', purpose: 'Remembers your preferred language', duration: '12 months' },
      { name: 'zynex_tz', purpose: 'Stores your timezone preference', duration: '12 months' },
      { name: 'zynex_theme', purpose: 'Remembers your light/dark theme selection', duration: '12 months' },
      { name: 'zynex_chat', purpose: 'Preserves live chat widget state and history', duration: '30 days' },
      { name: 'zynex_layout', purpose: 'Saves your dashboard layout preferences', duration: '12 months' },
    ],
    required: false,
  },
  {
    ...
    cookies: [
      { name: 'zynex_analytics', purpose: 'Tracks page views and feature usage (anonymized)', duration: '12 months' },
      { name: 'zynex_perf', purpose: 'Measures page load times and performance metrics', duration: '30 days' },
      { name: 'zynex_ref', purpose: 'Identifies the source that referred you to our site', duration: 'Session' },
      { name: 'zynex_ab', purpose: 'Assigns you to A/B test groups for feature improvements', duration: '90 days' },
    ],
    required: false,
  },
];
      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-sm text-[#555555] leading-relaxed mb-12">
            Zynex uses cookies and similar technologies (local storage, session storage) to operate the platform, remember your preferences, and improve your experience. This policy explains what cookies we use, why we use them, and how you can manage them.
          </p>

          {/* Cookie categories */}
          <h2 className="text-2xl font-bold text-[#111111] mb-2">What Cookies Does Zynex Use?</h2>
          <div className="w-12 h-0.5 bg-[#056CB8] mb-6"></div>
          ...
          <div className="w-12 h-0.5 bg-[#056CB8] mb-6"></div>
          <p className="text-sm text-[#555555] leading-relaxed mb-4">
            Zynex does not allow third-party advertising cookies on our platform. However, in limited cases, embedded content or integrations may set their own cookies:
          </p>
          ...
          <div className="flex flex-col gap-6 mb-12">
            <div className="bg-[#f5f5f5] border border-[#e0e0e0] p-6">
              ...
              <p className="text-sm text-[#555555] leading-relaxed">
                When you first visit Zynex, you'll see a cookie consent banner where you can accept or reject optional cookies (functional and analytics). You can change your preferences at any time from the footer "Cookie Settings" link.
              </p>
            </div>
            ...
            <div className="bg-[#f5f5f5] border border-[#e0e0e0] p-6">
              ...
              <p className="text-sm text-[#555555] leading-relaxed">
                Most browsers allow you to block or delete cookies through their settings. Note that blocking strictly necessary cookies will prevent the Zynex platform from functioning. Refer to your browser's help documentation for instructions.
              </p>
            </div>
            ...
            <div className="bg-[#f5f5f5] border border-[#e0e0e0] p-6">
              ...
              <p className="text-sm text-[#555555] leading-relaxed">
                There is no universal standard for how websites should respond to DNT signals. Currently, Zynex does not alter its data collection practices in response to DNT browser settings. We recommend using our cookie consent banner for granular control.
              </p>
            </div>
          </div>
          ...
          <div className="w-12 h-0.5 bg-[#056CB8] mb-6"></div>
          <p className="text-sm text-[#555555] leading-relaxed">
            If you have questions about our use of cookies, contact us at <strong>privacy@zynex.ai</strong> or visit our <a href="/privacy-policy" className="text-[#056CB8] underline">Privacy Policy</a> for full details on how we handle your data.
          </p>
